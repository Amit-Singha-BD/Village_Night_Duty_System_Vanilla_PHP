            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    foreach($memberList as $member){
                        ...
                        echo "<td class='text-center'><a href='View.php' class='btn btn-success'>View</a>
                                                      <a href='View.php' class='btn btn-info'>Edit</a>
                                                      <a href='View.php' class='btn btn-danger'>Delete</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
